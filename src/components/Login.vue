  ...
  <div class="lg:mx-auto md:mx-auto sm:mx-auto">
    <div>
      <header class="grid grid-row grid-cols-2 gap-64 w-full mx-auto mt-10">
        <div class="mx-auto">
          <a href="https://pacer-hr.netlify.app/"
    ...
    >
      <form>
        ...
        <input
          v-model="employeeid"
          name="employeeid"
          class="bg-gray-200 rounded w-full py-3 px-3 my-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline-blue focus:border-blue-300"
          type="text"
          placeholder="Pacer-HR Domain"
        />

        <input
          class="bg-gray-200 rounded w-full py-3 px-3 text-gray-700 mt-2 my-6 leading-tight focus:outline-none focus:shadow-outline-blue focus:border-blue-300"
          v-model="password"
          type="password"
          name="password"
